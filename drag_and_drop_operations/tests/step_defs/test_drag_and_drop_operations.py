...
def verify_existence_of_capital_in_the_list(main_function, capital_name):
    ...
    assert capital_name in list_of_capitals, "capital name doesn't exist in list of capitals"
...
def verify_existence_of_country_in_the_list(main_function, country_name):
    ...
    assert country_name in list_of_countries, "country name doesn't exist in list of countries"
...
def check_color_of_capital_block(main_function, rgb_color):
    ...
    assert background_color == rgb_color, "different rgb color was received"
